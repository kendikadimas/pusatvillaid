...
export default function AdminLoginPage() {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center text-[#222222] px-4 relative overflow-hidden bg-gradient-to-br from-green-50/50 via-white to-green-50/30">
            <div className="relative z-10 w-full max-w-md">
                <div className="bg-white rounded-[14px] shadow-[0_0_0_1px_rgba(0,0,0,0.02),0_2px_6px_rgba(0,0,0,0.04),0_4px_8px_rgba(0,0,0,0.1)] p-7 sm:p-9 space-y-6">
                    <div className="text-center space-y-3">
                        <div className="w-14 h-14 bg-green-600 rounded-[14px] flex items-center justify-center mx-auto shadow-[0_0_0_1px_rgba(0,0,0,0.02),0_2px_6px_rgba(0,0,0,0.04),0_4px_8px_rgba(0,0,0,0.1)]">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        <div>
                            ...
                            <input 
                                ...
                                className="w-full bg-white border border-[#dddddd] rounded-[8px] px-3.5 py-2.5 text-sm text-[#222222] placeholder-[#6a6a6a] focus:outline-none focus:border-green-500 focus:ring-2 focus:ring-green-500/10 focus:bg-white transition-all font-semibold"
                            />
                        </div>
                        ...
                        <button 
                            type="submit"
                            disabled={submitting}
                            className="w-full bg-green-600 hover:bg-green-700 active:scale-[0.98] disabled:opacity-50 text-white font-bold py-3 rounded-[8px] transition-all flex items-center justify-center space-x-2 text-sm mt-6 cursor-pointer"
                        >
                            {submitting ? (
                                <>
