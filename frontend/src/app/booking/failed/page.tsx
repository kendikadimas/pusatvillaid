        ...
        <div className="flex-1 flex flex-col bg-slate-50 text-slate-800">
            ...
            <main className="max-w-md mx-auto px-4 py-16 w-full flex-1 flex flex-col justify-center">
                <div className="bg-white border border-slate-200 rounded-3xl p-6 sm:p-8 shadow-xl text-center space-y-6">
                    ...
                    <div>
                        <h1 className="font-serif text-xl sm:text-2xl font-medium text-[#0d0d0d] tracking-tight">Pembayaran Gagal</h1>
                    ...
                    <div className="flex flex-col gap-3 pt-4 border-t border-slate-100">
                        {code && (
                            <Link href={`/booking/status?code=${code}`} className="bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 rounded-xl shadow-lg transition-transform flex items-center justify-center space-x-2 text-sm">
                                <ArrowLeft className="w-4 h-4" />
                                <span>Cek Status & Bayar Ulang</span>
                            </Link>
                        )}
                        <Link href="/" className="bg-white hover:bg-slate-50 border border-slate-200 text-slate-700 font-bold py-3 rounded-xl shadow-sm transition-transform flex items-center justify-center space-x-2 text-sm">
