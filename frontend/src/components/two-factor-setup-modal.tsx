            ...
            {errors?.length ? (
                ...
                <>
                    ...
                    <div className="relative flex w-full items-center justify-center text-xs">
                        ...
                        <span className="relative bg-card px-2 py-1 text-muted-foreground">
                    ...
                    <div className="flex w-full space-x-2">
                        <div className="flex w-full items-stretch overflow-hidden rounded-xl border border-border">
                            {!manualSetupKey ? (
                                <div className="flex h-[46px] w-full items-center justify-center bg-muted p-3">
                                    <Spinner />
                                </div>
                            ) : (
                                <>
                                    <input
                                        ...
                                        className="h-[46px] w-full bg-background p-3 text-sm text-foreground outline-none"
                                    />
                                    <button
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (err.response?.data?.errors) {
                ...
                setErrors({ code: [err.response?.data?.message || 'Verification failed.'] });
            }
        }
    };
