            ...
            <div className="absolute top-0 right-0 h-full w-[310px] max-w-[85vw] bg-white shadow-2xl flex flex-col transition-transform duration-300 ease-out animate-slideInRight">
                ...
                <div className="flex items-center justify-between px-6 py-5 border-b border-slate-100 bg-slate-50/50">
                    <div className="flex items-center space-x-2">
                        <svg className="w-7 h-7 fill-current text-green-600" viewBox="0 0 32 32">
                ...
                <div className="px-6 py-6 border-b border-slate-100 bg-gradient-to-r from-green-50/50 to-green-50/20">
                    {user || admin ? (
                        <div className="flex items-center space-x-3.5">
                            <div className="w-12 h-12 rounded-full bg-green-600 text-white flex items-center justify-center font-bold text-base shadow-md border-2 border-white">
                            ...
                            <div className="min-w-0 flex-1">
                                ...
                                <Link 
                                    ...
                                    onClick={onClose}
                                    className="text-[11px] font-bold text-green-600 hover:text-green-700 underline mt-1 block"
                                >
                        ...
                        <div className="space-y-3">
                            ...
                            <Link
                                href="/login"
                                onClick={onClose}
                                className="w-full bg-green-600 hover:bg-green-700 text-white font-bold text-xs py-2.5 px-4 rounded-xl transition-all shadow-sm flex items-center justify-center space-x-2 active:scale-95 cursor-pointer"
                            >
                ...
                <div className="flex-1 px-4 py-6 space-y-1.5 overflow-y-auto">
                    ...
                    <Link
                        href="/"
                        onClick={onClose}
                        className="flex items-center space-x-3 px-3 py-3 rounded-xl text-slate-700 hover:bg-slate-50 hover:text-green-600 transition-all font-semibold text-[14px]"
                    >
